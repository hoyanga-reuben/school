...
urlpatterns = [
    ...
    path('school-pending-transfers/', views.school_pending_transfers, name='school_pending_transfers'),
    path('district-pending-transfers/', views.district_pending_transfers, name='district_pending_transfers'),
    path('region-pending-transfers/', views.region_pending_transfers, name='region_pending_transfers'),
